...
const std::vector<AudioSpectrumInstant>& AudioSpectrum::getSpectrum() const
{
	return m_spectrum;
}

const std::vector<AudioSpectrumInstant>& AudioSpectrum::getNormalisedSpectrum() const
{
...
bool AudioSpectrum::isInitialised() const
{
